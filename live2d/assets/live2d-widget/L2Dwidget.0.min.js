	...
	142: function(t, i, e) {
		...
		a.prototype = new r.L2DBaseModel, a.prototype.load = function(t, i, e) {
			...
			this.modelSetting.loadModelSetting(i, function() {
				var t = n.modelSetting.getModelFile();
				/^http/.test(t) || (t = n.modelHomeDir + t), n.loadModelData(t, function(t) {
					for(var i = 0; i < n.modelSetting.getTextureNum(); i++) {
						var o = n.modelSetting.getTextureFile(i);
						/^http/.test(o) || (o = n.modelHomeDir + o), n.loadTexture(i, o, function() {
							if(n.isTexLoaded) {
								if(n.modelSetting.getExpressionNum() > 0) {
									...
									for(var t = 0; t < n.modelSetting.getExpressionNum(); t++) {
										var i = n.modelSetting.getExpressionName(t),
											o = n.modelSetting.getExpressionFile(t);
										/^http/.test(o) || (o = n.modelHomeDir + o), n.loadExpression(i, o)
									}
								...
								if(null == n.eyeBlink && (n.eyeBlink = new r.L2DEyeBlink), null != n.modelSetting.getPhysicsFile()) {
									var _ = n.modelSetting.getPhysicsFile();
									/^http/.test(_) || (_ = n.modelHomeDir + _), n.loadPhysics(_)
								} else n.physics = null;
								var a = n.modelSetting.getPoseFile();
								if(null != a ? n.loadPose(/^http/.test(a) ? a : n.modelHomeDir + a, function() {
										n.pose.updateParam(n.live2DModel)
									}) : n.pose = null, null != n.modelSetting.getLayout()) {
									var h = n.modelSetting.getLayout();
									null != h.width && n.modelMatrix.setWidth(h.width), null != h.height && n.modelMatrix.setHeight(h.height), null != h.x && n.modelMatrix.setX(h.x), null != h.y && n.modelMatrix.setY(h.y), null != h.center_x && n.modelMatrix.centerX(h.center_x), null != h.center_y && n.modelMatrix.centerY(h.center_y), null != h.top && n.modelMatrix.top(h.top), null != h.bottom && n.modelMatrix.bottom(h.bottom), null != h.left && n.modelMatrix.left(h.left), null != h.right && n.modelMatrix.right(h.right)
								}
			...
			for(var i = this, e = 0; e < this.modelSetting.getMotionNum(t); e++) {
				var r = this.modelSetting.getMotionFile(t, e),
					o = /^http/.test(r) ? r : this.modelHomeDir + r;
				this.loadMotion(r, o, function(r) {
			...
			if(null != r && "" != r) {
				...
				var o, n = this;
				null == this.motions[t] ? (r = /^http/.test(r) ? r : this.modelHomeDir + r, this.loadMotion(null, r, function(r) {
			...
			if(r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)), s.cDefine.DEBUG_LOG && console.log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, i)) this.mainMotionManager.startMotionPrio(r, e);
				...
				_.src = /^http/.test(n) ? n : this.modelHomeDir + n, s.cDefine.DEBUG_LOG && console.log("Start sound : " + n), _.play(), this.mainMotionManager.startMotionPrio(r, e)
			}
